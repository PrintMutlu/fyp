...
class RequirementStateController extends GetxController {
  ...
  startScanning() async {
    await bluetoothPermissionCheck(); // Bluetooth izinlerini talep et
  ...
  Future<void> bluetoothPermissionCheck() async {
    var bluetoothScanStatus = await Permission.bluetoothScan.request();
    var bluetoothAdvertiseStatus = await Permission.bluetoothAdvertise.request();

    if (bluetoothScanStatus.isGranted && bluetoothAdvertiseStatus.isGranted) {
      print('bluetoothPermissionCheck true.');
    } else {
      print('bluetoothPermissionCheck false');
    }
  }
}
